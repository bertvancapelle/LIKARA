...
| ADR-056 | Vragen evolueren: de formulering wordt bevroren bij het antwoord — de beheerder kiest zelf verduidelijking vs. echte wijziging (nooit uit de tekst afgeleid; zelfde keuze bij optie-uitbreiding én label-hernoemen, ook afgeleide sets), één sein per vraag voor iedereen die antwoordde (LI051 — niet per onderdeel, ook wie het keuzeveld leeg liet), verouderd leest neutraal (nooit amber/rood) en dooft door **opnieuw te antwoorden** (LI051 — geen bevestigingsknop; onderdelen openen leeg, toelichting blijft), oude formulering in de vraag-geschiedenis (consultant-leesbaar, LI051; tenant-logboek blijft dicht), telt mee in het Open punten-tabbladgetal dat beide soorten werk telt (LI051; niet-blokkerend blok, geen poort), vandaag is het nulpunt (LI051), totaalbeeld + voorspelling-vóór-opslaan in het vraagbeheer-scherm uit één telling; mockup-besluiten 13–16: één opslaan-moment per vraag (keuze één keer, met opsomming + telling), antwoordtype-slot aan de bron (veld dicht mét reden), uitgezette optie zichtbaar én heractiveerbaar (domeinbesluit — heractiveren bestaat nog niet), geen voorgeselecteerde keuze in het opslaan-venster; invariant: nooit blok "dit moet nog", nooit de score legen; verworpen: vraagversies, audit als leeslaag, "klopt nog"-knop | Voorstel — besloten (LI050, aangescherpt LI051); bouw volgt, sliceverdeling apart |
