...
| ADR-045 | "Ondersteunt werk" als eigenschap van het componenttype: beheerbare catalogus-vlag `ondersteunt_werk` (ruim: incl. fileshare/client_software), picker weert vooraf + scope-regel (uitleg-bouwsteen verworpen), flip = zichtbaarheid nooit veldwerk, werkvoorraad i.p.v. speurtocht, afgeleid signaal; incl. 422-bugfix componenttype-aanmaak | Besloten (LI040) — bouw volgt (slice 1 schema-gate; besluiten 7–8 landen in gate 2/3) |
