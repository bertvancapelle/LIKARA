...
VERWACHT = {
    ...
    Entiteit.ORGANISATIEGEBRUIK: _INHOUD,   # ADR-036 — grof gebruiksfeit
...
def test_matrix_volledig_inclusief_negatief():
    """Elke entiteit × rol × actie (26×4×4 = 416 combinaties) tegen de spec (ADR-042: +PROCES/+PROCESVERVULLING)."""
