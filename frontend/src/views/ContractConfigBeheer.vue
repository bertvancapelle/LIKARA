        ...
        <table class="w-full text-[length:var(--lk-text-sm)]" :data-testid="`cat-tabel-${dim.key}`">
          ...
          <tbody>
            ...
            >
              ...
              <td class="text-right">
                <div v-if="magBeheren" class="flex justify-end gap-[var(--lk-space-xs)]">
            ...
            <tr v-if="!perDimensie(dim.key).length">
              <td colspan="5" :data-testid="`cat-leeg-${dim.key}`" class="py-[var(--lk-space-sm)] text-[var(--lk-color-text-muted)]">
