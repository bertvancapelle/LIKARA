<script setup>
/**
 * WorkPackageLijstView — migratielaag (ADR-023 Fase F / F-1): lijst van werkpakketten.
 * Read-only; leunt op `GET /work-packages`. Keyset-paginering ("Meer laden").
 */
    ...
    >
      ...
      <template #empty>
        <span v-if="eersteGeladen && !laden" data-testid="wp-lijst-leeg">
          Nog geen werkpakketten geregistreerd.
        </span>
