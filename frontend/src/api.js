...
export const api = {
  ...
  componenten: {
    ...
    lijst: (params = {}) =>
      request(
        `/componenten${_filterQuery('componenten.lijst', params, ['limit', 'after', 'sort', 'order', 'componenttype', 'laag', 'status', 'hostingmodel', 'eigenaar_organisatie_id', 'leverancier_id', 'zoek', 'klaarverklaring', 'afwijking'])}`,
      ),
