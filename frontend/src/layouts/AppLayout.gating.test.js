...
const NAMEN = [
  'dashboard', 'component-lijst', 'proces-lijst', 'bedrijfsfunctie-lijst', 'partij-lijst', 'contract-lijst', 'blokkades',
  'architectuur', 'landschapskaart', 'plaatsingssignalen', 'signalering', 'checklistvragen', 'norm-beheer',
