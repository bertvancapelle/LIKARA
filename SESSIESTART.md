...
4. Bevestig: "Sessiestart compleet — LIKARA V040 — [N] skills geladen"
...
# SESSIE_BRIEFING.md — LIKARA V040
...
```
cf0f046 LI039 gate 1b: referentiemodel inlezen (AMEFF) — ADR-043/044
85b9cf5 LI039 gate 1a-bis: plaatsing als eerste-klas feit — ADR-044
605299a LI039 gate 1a: bedrijfsfunctie-as (ADR-043) — subtype + referentiemodel + functieboom-scherm
b46f4b0 LI038: sessie-afsluiting (V039)
...
3. Bevestig: "Sessie-briefing geladen — LIKARA V040"
